<div id="Grid" class="row section">	
	<div class="col-md-12 doc-header">
		<h3>Grid</h3>
		<p>The grid default is 12 columns. Spaced with padding. Available breakpoint are <code>xs</code>, <code>sm</code>, <code>md</code>, <code>lg</code>. Available classes are <code>col-[breakpoint]-[num]</code>,<code>col-[breakpoint]-offset-[num]</code>. Wrap the columns in a row to cancel the first and last columns extra padding.</p>
		<br>
	</div>
	<div class="grid">
